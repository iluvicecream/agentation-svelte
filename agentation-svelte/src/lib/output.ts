...
export function generateOutput(
  ...
  const getCompactElementLabel = (annotation: Annotation): string => {
    if (!annotation.isMultiSelect) return annotation.element;
    if (annotation.element === "Area selection") return annotation.element;
